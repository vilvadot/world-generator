...
exports.config = exports.percentages = void 0;
var percentages = {
  1: 0.01,
  10: 0.1,
  100: 1
...
},{"buffer":"node_modules/buffer/index.js"}],"node_modules/postal/lib/postal.js":[function(require,module,exports) {
var define;
var global = arguments[3];
/**
...
},{"lodash":"node_modules/lodash/lodash.js"}],"js/events.js":[function(require,module,exports) {
"use strict";
...
var Bus = /*#__PURE__*/function () {
  ...
  _createClass(Bus, [{
    key: "emit",
    value: function emit(message, data, channel) {
      return _postal.default.publish({
        channel: channel,
        topic: message,
        data: data
      });
    ...
    key: "subscribe",
    value: function subscribe(message, callback, channel) {
      return _postal.default.subscribe({
        channel: channel,
        topic: message,
        callback: callback
      });
...
},{"postal":"node_modules/postal/lib/postal.js"}],"js/main.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Universe, [{
    ...
    value: function bigBang() {
      ...
      setInterval(function () {
        _this.advanceAYear();
      }, _config.config.TICK_TIME);
    }
  }, {
    key: "advanceAYear",
    value: function advanceAYear() {
      this.year++;
      this.bus.emit(_events.events.YEAR_CHANGE, {
        year: this.year
      });
    }
  }]);
...
var rollSuccess = function rollSuccess() {
  var chance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  var roll = Math.random();
  var succes = roll > 1 - chance;
  return succes;
};

var withChance = function withChance(chance, callback) {
...
var PlanetManager = /*#__PURE__*/function () {
  function PlanetManager(bus) {
    var _this2 = this;

    _classCallCheck(this, PlanetManager);

    this.bus = bus;
    this.planets = [];
    this.bus.subscribe(_events.events.YEAR_CHANGE, function () {
      withChance(_config.percentages["100"], function () {
        return _this2.createPlanet();
      });
    });
  }

  _createClass(PlanetManager, [{
    key: "createPlanet",
    value: function createPlanet() {
      var planet = "Planet: ".concat(Math.random());
      this.planets.push(planet);
      this.bus.emit(_events.events.PLANETS_UPDATE, {
...
},{"./config":"js/config.js","./events":"js/events.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
