...
},{"./toInteger":"node_modules/lodash/toInteger.js"}],"node_modules/lodash/_arraySome.js":[function(require,module,exports) {
/**
...
},{"./_baseForOwn":"node_modules/lodash/_baseForOwn.js","./_createBaseEach":"node_modules/lodash/_createBaseEach.js"}],"node_modules/lodash/_baseSome.js":[function(require,module,exports) {
...
},{"./_baseEach":"node_modules/lodash/_baseEach.js"}],"node_modules/lodash/_isIterateeCall.js":[function(require,module,exports) {
var eq = require('./eq'),
    isArrayLike = require('./isArrayLike'),
    isIndex = require('./_isIndex'),
    isObject = require('./isObject');
...
},{"./eq":"node_modules/lodash/eq.js","./isArrayLike":"node_modules/lodash/isArrayLike.js","./_isIndex":"node_modules/lodash/_isIndex.js","./isObject":"node_modules/lodash/isObject.js"}],"node_modules/lodash/some.js":[function(require,module,exports) {
...
},{"./_arraySome":"node_modules/lodash/_arraySome.js","./_baseIteratee":"node_modules/lodash/_baseIteratee.js","./_baseSome":"node_modules/lodash/_baseSome.js","./isArray":"node_modules/lodash/isArray.js","./_isIterateeCall":"node_modules/lodash/_isIterateeCall.js"}],"node_modules/lodash/_apply.js":[function(require,module,exports) {
/**
...
},{"./identity":"node_modules/lodash/identity.js","./_overRest":"node_modules/lodash/_overRest.js","./_setToString":"node_modules/lodash/_setToString.js"}],"node_modules/lodash/_metaMap.js":[function(require,module,exports) {
...
},{"./_baseRest":"node_modules/lodash/_baseRest.js","./_createWrap":"node_modules/lodash/_createWrap.js","./_getHolder":"node_modules/lodash/_getHolder.js","./_replaceHolders":"node_modules/lodash/_replaceHolders.js"}],"node_modules/lodash/now.js":[function(require,module,exports) {
var root = require('./_root');
...
},{"./isObject":"node_modules/lodash/isObject.js","./now":"node_modules/lodash/now.js","./toNumber":"node_modules/lodash/toNumber.js"}],"node_modules/lodash/_castFunction.js":[function(require,module,exports) {
var identity = require('./identity');
...
},{"./forEach":"node_modules/lodash/forEach.js"}],"node_modules/lodash/_baseAssignValue.js":[function(require,module,exports) {
...
},{"./_assignValue":"node_modules/lodash/_assignValue.js","./_baseAssignValue":"node_modules/lodash/_baseAssignValue.js"}],"node_modules/lodash/_createAssigner.js":[function(require,module,exports) {
var baseRest = require('./_baseRest'),
    isIterateeCall = require('./_isIterateeCall');
...
},{"./_arrayFilter":"node_modules/lodash/_arrayFilter.js","./_baseFilter":"node_modules/lodash/_baseFilter.js","./_baseIteratee":"node_modules/lodash/_baseIteratee.js","./isArray":"node_modules/lodash/isArray.js"}],"node_modules/lodash/isEqual.js":[function(require,module,exports) {
var baseIsEqual = require('./_baseIsEqual');
...
},{"./_baseIsEqual":"node_modules/lodash/_baseIsEqual.js"}],"node_modules/lodash/_baseMap.js":[function(require,module,exports) {
var baseEach = require('./_baseEach'),
    isArrayLike = require('./isArrayLike');
...
},{"./_arrayMap":"node_modules/lodash/_arrayMap.js","./_baseIteratee":"node_modules/lodash/_baseIteratee.js","./_baseMap":"node_modules/lodash/_baseMap.js","./isArray":"node_modules/lodash/isArray.js"}],"node_modules/lodash/throttle.js":[function(require,module,exports) {
...
},{"./debounce":"node_modules/lodash/debounce.js","./isObject":"node_modules/lodash/isObject.js"}],"js/lib/postal.min.js":[function(require,module,exports) {
var define;
...
(function (e, t) {
  ...
  "function" == typeof define && define.amd ? define(function () {
    return t(n, e);
  }) : "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = t(n, this) : e.postal = t(n, e);
})(this, function (e, t, n) {
  function i() {
    for (; y.length;) {
      h.unsubscribe(y.shift());
    }
  }

  function r(e, t, n) {
    return function (i, r, c) {
      i === e && c.splice(r, 1), 0 === c.length && delete n[t];
    };
  }
  ...
  function c(e, t, n, i, r) {
    ...
    return function (r) {
      var o;
      l.resolver.compare(r.topic, e, c) && (c.resolverNoCache || (o = t[n] = t[n] || [], o.push(r), r.cacheKeys.push(n)), i && i(r));
    };
  }
  ...
  function s(t, n) {
    return "function" == typeof t ? t : t ? function (i) {
      ...
      return e.each(t, function (e, o) {
        r += 1, ("topic" === o && n.compare(i.topic, t.topic, {
          resolverNoCache: !0
        }) || "context" === o && t.context === i._context || i[o] === t[o]) && (c += 1);
      }), r === c;
    } : function () {
      return !0;
    };
  ...
  f.prototype.subscribe = function () {
    ...
    var t,
        n = {};
    if ("string" == typeof arguments[0] ? (n.topic = arguments[0], n.data = arguments[1], t = arguments[2]) : (n = arguments[0], t = arguments[1]), "object" != _typeof(n)) throw new Error("The first argument to ChannelDefinition.publish should be either an envelope object or a string topic.");
    n.headers = e.extend(n.headers || {
      resolverNoCache: l.resolverNoCache
    }), n.channel = this.channel, this.bus.publish(n, t);
  };
  ...
  p.prototype = {
    ...
    disposeAfter: function disposeAfter(t) {
    ...
    invokeSubscriber: function invokeSubscriber(e, t) {
      if (!this.inactive) {
        var n = this,
            i = n.pipeline,
            r = i.length,
        ...
        if (r) {
          ...
          var a = function u(e, t) {
            o += 1, o < r ? i[o].call(c, e, t, u) : (n.callback.call(c, e, t), s = !0);
          };

          a(e, t, 0);
        } else n.callback.call(c, e, t), s = !0;
    ...
    constraints: function constraints(t) {
      var n = this;
    ...
    debounce: function debounce(t, n) {
  ...
  var v = (l.resolver = {
    ...
    regex: {},
    enableCache: !0,
    compare: function compare(t, n, i) {
      var r,
          c,
          o,
          s = n + l.cacheKeyDelimiter + t,
          a = this.cache[s],
          u = i || {},
          h = this.enableCache && !u.resolverNoCache;
      return a === !0 ? a : t.indexOf("#") === -1 && t.indexOf("*") === -1 ? (a = n === t, h && (this.cache[s] = a), a) : ((c = this.regex[t]) || (r = "^" + e.map(t.split("."), function (e) {
        var t = "";
        return o && (t = "#" !== o ? "\\.\\b" : "\\b"), t += "#" === e ? "[\\s\\S]*" : "*" === e ? "[^.]+" : e, o = e, t;
      }).join("") + "$", c = this.regex[t] = new RegExp(r)), a = c.test(n), h && (this.cache[s] = a), a);
    },
    ...
    purge: function purge(t) {
      var n = this,
          i = l.cacheKeyDelimiter,
          r = function r(e, _r) {
        var c = _r.split(i),
            o = c[0],
            s = c[1];

        "undefined" != typeof t.topic && t.topic !== o || "undefined" != typeof t.binding && t.binding !== s || delete n.cache[_r];
      },
          c = function c(e, t) {
        var r = t.split(i);
  ...
  if (e.extend(h, {
    ...
    addWireTap: function addWireTap(e) {
      var t = this;
    ...
    getSubscribersFor: function getSubscribersFor(t) {
      var n = [],
          i = this;
    ...
    publish: function publish(t, n) {
      ...
      if (a) e.each(a, function (e) {
        ...
        var f = c(o, this.cache, s, function (e) {
          e.invokeSubscriber(t.data, t) ? h++ : u++;
        }, t);
    ...
    subscribe: function subscribe(t) {
      var n,
          ...
          r = new p(t.channel || l.DEFAULT_CHANNEL, t.topic, t.callback),
          o = i[r.channel],
          s = r.channel.length;
      o || (o = i[r.channel] = {}), n = i[r.channel][r.topic], n || (n = i[r.channel][r.topic] = []), n.push(r);
      var a = this.cache;
      return e.each(e.keys(a), function (e) {
        e.substr(0, s) === r.channel && c(e.split(l.cacheKeyDelimiter)[1], a, e)(r);
      }), l.enableSystemMessages && this.publish(g(r)), r;
    },
    unsubscribe: function unsubscribe() {
      for (var t, n, i, c, o = arguments.length, s = 0; s < o; s++) {
        ...
        if (n = this.subscriptions[t.channel], i = n && n[t.topic]) {
          ...
          if (0 === i.length && (delete n[t.topic], e.keys(n).length || delete this.subscriptions[t.channel]), t.cacheKeys && t.cacheKeys.length) for (var u; u = t.cacheKeys.pop();) {
            e.each(this.cache[u], r(t, u, this.cache));
          }

          if ("function" == typeof l.resolver.purge) {
            var h = l.autoCompactResolver === !0 ? 0 : "number" == typeof l.autoCompactResolver && l.autoCompactResolver - 1;
            h >= 0 && m === h ? (l.resolver.purge({
              compact: !0
            }), m = 0) : h >= 0 && m < h && (m += 1);
          }
        }
    ...
    unsubscribeFor: function unsubscribeFor(e) {
      var t = [];
      this.subscriptions && (t = this.getSubscribersFor(e), this.unsubscribe.apply(this, t));
    }
  }), t && Object.prototype.hasOwnProperty.call(t, "__postalReady__") && e.isArray(t.__postalReady__)) for (; t.__postalReady__.length;) {
    t.__postalReady__.shift().onReady(h);
  }
  return h;
});
},{"lodash/after":"node_modules/lodash/after.js","lodash/some":"node_modules/lodash/some.js","lodash/bind":"node_modules/lodash/bind.js","lodash/debounce":"node_modules/lodash/debounce.js","lodash/each":"node_modules/lodash/each.js","lodash/assign":"node_modules/lodash/assign.js","lodash/filter":"node_modules/lodash/filter.js","lodash/isEqual":"node_modules/lodash/isEqual.js","lodash/keys":"node_modules/lodash/keys.js","lodash/map":"node_modules/lodash/map.js","lodash/throttle":"node_modules/lodash/throttle.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/lib/postal.min.js"], null)
//# sourceMappingURL=/postal.min.f4a65322.js.map